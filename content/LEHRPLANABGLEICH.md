# Lehrplanabgleich: Start in Klasse 7
...
- [Englisch 5, erste Fremdsprache](https://www.lehrplanplus.bayern.de/fachlehrplan/gymnasium/5/englisch)
- [Englisch 6, erste Fremdsprache](https://www.lehrplanplus.bayern.de/fachlehrplan/gymnasium/6/englisch/1-fremdsprache)
- [Englisch 7, erste Fremdsprache](https://www.lehrplanplus.bayern.de/fachlehrplan/gymnasium/7/englisch/1-fremdsprache)
...
| Bereich | Klasse | Einordnung |
|---|---|---|
| Gegenwart | 5 | Simple present und present progressive. |
| Vergangenheit | 5 / 6 | Simple past in 5; past progressive in 6. |
| Present perfect | 6 | Auf vergangene Handlungen mit relevantem Ergebnis beschränkt; simple past aus 5 zum Vergleich. |
| Zukunft und Bedingungen | 6 | Will, going to, Fahrplan-Zukunft und reale Bedingungen. |
| Fragen | 5 / 6 | Grundformen in 5; Frageanhänge und Fragen mit Präpositionen in 6. |
| Modalverben | 5 / 6 | Grundlagen in 5; weitere Modalverben und Ersatzformen in 6. |
| Vergleiche | 6 | Steigerung und Vergleich von Adjektiven. |
| Mengenwörter | 5 / 6 | Grundlegende Mengenangaben in 5; weitere unbestimmte Mengen in 6. |
| Pronomen und Besitz | 5 | Personalpronomen, Possessivbegleiter, Genitiv, Demonstrativa und einfache indefinite Formen. |
| Relativsätze | 6 | Bestimmende Relativsätze, auch mit weglassbarem Objektpronomen. |
| Präpositionen und Uhrzeiten | 5 / 6 | Einordnung über Zeit-/Ortswortschatz und feste Verbindungen. |
| Satzverknüpfungen | 5 / 6 | Einfache Verbindungen in 5; Erweiterung etwa um obwohl, während und damit in 6. |
| Mehrzahl | 5 | Regelmäßige und unregelmäßige Pluralformen. |
| Typische Verwechslungen | 5 / 6 | Lexikalische Ergänzung: häufige Wendungen, Schreibweisen und false friends; kein zusätzlicher Grammatiklehrgang. |
